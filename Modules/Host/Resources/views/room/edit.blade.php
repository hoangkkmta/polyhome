...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('host.phong-cho-thue.update', [ $data->id ]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="form-group d-flex justify-content-center">
                            <a href="{{ route('host.phong-cho-thue.index') }}" class="btn btn-lg btn-default mr-3">Trở lại</a>
