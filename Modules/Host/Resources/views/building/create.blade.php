                ...
                <div class="card-body">
                    <form action="{{ route('host.nha-cho-thue.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Ảnh đại diện:</label>
                                <input id="img-2" type="file" class="form-control" name="image[]" onchange="changeImg2(this)">
                                <img id="image-2" class="img-thumbnail img-fluid mt-3"  src="img/import-img.png">
                                <br>
                                @error('image')
                                <span class="mt-3 errorMsg text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                <label>Ảnh đại diện:</label>
                                <input id="img-3" type="file" class="form-control" name="image[]" onchange="changeImg3(this)">
                                <img id="image-3" class="img-thumbnail img-fluid mt-3"  src="img/import-img.png">
                                <br>
                                @error('image')
                                <span class="mt-3 errorMsg text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                <label>Ảnh đại diện:</label>
                                <input id="img-4" type="file" class="form-control" name="image[]" onchange="changeImg4(this)">
                                <img id="image-4" class="img-thumbnail img-fluid mt-3"  src="img/import-img.png">
                                <br>
                                @error('image')
                                <span class="mt-3 errorMsg text-danger">{{ $message }}</span>
                                @enderror
