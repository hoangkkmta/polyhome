        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-lg-12 d-flex justify-content-center">
                                <div class="form-group mx-auto mt-3">
                                    <button type="submit" class="flat-button bg-theme">Lấy lại mật khẩu</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ route('customer.formRegister') }}" style="float: left">Đăng ký tài khoản mới</a>
                            <a href="{{ route('customer.formLogin') }}" style="float: right">Đăng nhập</a>
                        </div>
                    </div>
                </div><!-- /.col-md-4 -->
